...
if ($filter_circle > 0) {
    $filter_where .= " AND ci.id = $filter_circle";
}
if ($filter_zone > 0) {
    $filter_where .= " AND z.id = $filter_zone";
}
if ($filter_branch > 0) {
    $filter_where .= " AND b.id = $filter_branch";
}
if ($filter_officer > 0) {
    $filter_where .= " AND c.assigned_officer = $filter_officer";
}

/* =========================
   Dropdown Scope Queries
========================= */
...
<head>
    <meta charset="UTF-8">
    <title>রিকভারি হয়নি রিপোর্ট</title>
...
<div class="topbar">
    <div>
        <div class="topbar-title">রিকভারি হয়নি রিপোর্ট</div>
...
<div class="container">
    ...
    <div class="hero">
        <div>
            <h2>No Recovery Customer List</h2>
            <p>যেসব গ্রাহকের কোনো recovery entry নেই, তাদের priority follow-up দরকার।</p>
        </div>
    ...
    <div class="box" style="margin-bottom:18px;">
        <form method="GET" style="display:grid; grid-template-columns:repeat(auto-fit,minmax(180px,1fr)); gap:12px; align-items:end;">
            ...
            <div>
                ...
                <a class="btn btn-orange" href="<?php echo basename($_SERVER['PHP_SELF']); ?>">Reset</a>
            </div>
    ...
    <div class="cards">
        <div class="card">
            <span>রিকভারি হয়নি এমন গ্রাহক</span>
    ...
    <div class="box">
        ...
        <?php } else { ?>
            <p class="muted">এই scope-এ recovery হয়নি এমন কোনো গ্রাহক পাওয়া যায়নি।</p>
        <?php } ?>
    </div>
